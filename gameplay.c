...
int gameplay(void) {
	...
	struct items items[MAX_ITEMS] = { {0,0,"b-"},{0,0,"hp+"}, {0,0,"b+"},{0,0,"b+"},{0,0,"s+"},{0,0,"key"},{0,0,"key"},{0,0,"game"},{0,0,"game"}};
	...
	while (1) {
		...
		if (input == BACK) { remove_portal(); return BACK; }
		if (input == CLEAR_V) { remove_portal(); return CLEAR_V; }
		if (input == FAIL_V) { remove_portal(); return FAIL_V; }
...
int gameplayEasy(void) {
	...
	struct items items[MAX_ITEMS_E] = { {0,0,"\0"},{0,0,"\0"},{0,0,"game"},{0,0,"game"},{0,0,"\0"},{0,0,"key"},{0,0,"key"}};
	HP = 0;
