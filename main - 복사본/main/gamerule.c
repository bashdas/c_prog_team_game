...
void item_ex(void) {
	...
	Setcolor(7); gotoxy(MAP_X + (MAP_WIDTH - 14) / 2 + 4, MAP_Y + 10, "PLAYER LIFE");


	gotoxy(MAP_X + (MAP_WIDTH - 14) / 2, MAP_Y + 11, "PORTAL");

	Setcolor(2);
	gotoxy(MAP_X + (MAP_WIDTH - 14) / 2 + 4, MAP_Y + 11, "P"); Setcolor(7);
	gotoxy(MAP_X + (MAP_WIDTH - 14) / 2 + 6, MAP_Y + 11, "TRNSPORT TO CONNECTED PORTAL");
