...
#define MAX_ITEMS 9 // 아이템 수 NORMAL, HARD
#define MAX_ITEMS_E 7 // EASY
...
/* ************ menuselect.c ************ */
int menuDraw1(void);			            // GAMESTART, GAMERULE, OPTION, ITEM_EX GAMEEXIT 반환
void menuDraw1Content(void);                // 사용자와 상호작용 없는 메뉴 출력물
void menuDraw2Content(int c1, int c2, int c3, int c4, int c5); // 사용자와 상호작용이 있는 메뉴 출력물
