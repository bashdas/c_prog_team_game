...
int minigame(int mode)
{
    ...
    switch (guess)
    {
    case 5: printf("\n오 모두 맞히셨습니다! 배터리가 100 증가합니다!"); break;
    case 4: printf("\n거의 다 맞히셨습니다! 배터리가 40 증가합니다!"); break;
    case 3: printf("\n많이 맞히셨습니다! 배터리가 30 증가합니다!"); break;
    case 2: printf("\n2개 맞히셨습니다! 배터리가 20 증가합니다!"); break;
    default: printf("\n흠.... 운이 없군요. 배터리가 감소합니다 ㅠㅠ"); break;
    }
    Sleep(2000);
